...
const zhDict = {
  ...
  pluginsSearchClear: "清空搜索",
  pluginsSearchEmpty: "未找到匹配的插件",
  pluginInstalledAt: "安装于",
  pluginsRefresh: "刷新",
  uninstall: "卸载",
  uninstalling: "卸载中...",
  ...
  targetVersion: "目标版本",
  selectVersionPlaceholder: "选择版本标签 (tag)",
  installSelectedVersion: "安装所选版本",
  executeInstallNow: "一键执行安装",
  executingInstall: "正在执行安装...",
  upgradeToSelectedVersion: "切换到所选版本",
  copyInstallCommand: "复制安装命令",
  pluginInstallTitle: "安装插件",
  pluginNamePlaceholder: "输入插件包名，如 dsh-rewind-plugin",
  pluginQueryVersions: "查询版本",
  pluginSelectVersion: "选择版本",
  pluginInstallAction: "安装",
  pluginInstalling: "安装中...",
  pluginUpdate: "切换版本",
  switchPluginVersionTitle: "切换插件版本",
  currentInstalledVersion: "当前安装版本",
  switchActionConfirm: "安装并切换",
  switchingAction: "正在安装切换...",
...
const enDict: Dict = {
  ...
  pluginsSearchClear: "Clear search",
  pluginsSearchEmpty: "No matching plugins found",
  pluginInstalledAt: "Installed",
  ...
  selectVersionPlaceholder: "Select version tag",
  installSelectedVersion: "Install Selected Version",
  executeInstallNow: "Install Now",
  executingInstall: "Installing...",
  upgradeToSelectedVersion: "Switch to Selected Version",
  copyInstallCommand: "Copy Install Command",
  pluginInstallTitle: "Install Plugin",
  pluginNamePlaceholder: "Enter plugin name, e.g. dsh-rewind-plugin",
  pluginQueryVersions: "Query Versions",
  pluginSelectVersion: "Select Version",
  pluginInstallAction: "Install",
  pluginInstalling: "Installing...",
  pluginUpdate: "Switch Version",
  switchPluginVersionTitle: "Switch Plugin Version",
  currentInstalledVersion: "Currently installed version",
  switchActionConfirm: "Install & Switch",
  switchingAction: "Switching...",
  loadingVersions: "Fetching available versions...",
